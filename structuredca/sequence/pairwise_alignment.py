...
class PairwiseAlignment:
    ...
    def __init__(
        ...
        # Count gap types
        self.left_gap, self.right_gap = self._count_tail_gaps(self.comparator)
        ...
        self.left_gap1, self.right_gap1 = self._count_tail_gaps(self.align1)
        self.tail_gap1: int = self.left_gap1 + self.right_gap1
        self.internal_gap1: int = self.gap1 - self.tail_gap1
        self.left_gap2, self.right_gap2 = self._count_tail_gaps(self.align2)
    ...
    # Dependencies -----------------------------------------------------------------
    @staticmethod
    def _count_tail_gaps(input_sequence: str) -> Tuple[int, int]:

        # Init
        gap = PairwiseAlignment.GAP_CHAR
        c1, c2 = 0, 0
